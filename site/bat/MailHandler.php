<?php
	$owner_email='cabanabaisoara@cabana-baisoara.ro';	
	$host = '';
	$port = '465';
	$username = '';
	$password = '';
	...
	if($owner_email=='' || $owner_email=='#'){
		return 'Attention, recipient e-mail is not set! Please define "owner_email" variable in the MailHanlder.php file.';
	}

	if(preg_match('/^(127\.|192\.168\.)/',$_SERVER['REMOTE_ADDR'])){
		return 'Attention, contact form will not work locally! Please upload your template to a live hosting server.';
	}
